...
import ModalFileEmployee from "../AwaitingApproval/component/ModalFileEmployee";
  ...
  return (
    <div>
      ...
      <div className="content-table">
        ...
        />
        {shouldOpenDialog&&<ModalFileEmployee setOpenModalFile={setShouldOpenDialog} openModalFile={shouldOpenDialog} id={idEmployee} setReRender={setReRender} reRender={reRender} onApproved={statusAwaiting}  />}
      </div>
    </div>
  );
}
